const AddCategory = {
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form @submit.prevent="submitForm" action="#" method="POST" enctype="multipart/form-data" id="categoryForm">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="description" name="description" rows="3" v-model="description" style="font-size: 17px;"></textarea>
                                                    </div>
    ...
    methods: {
        ...
        submitForm() {
            // Custom validation or actions before form submission
